...
function generateReportHTML($reportType, $reportId) {
    try {
        ...
        $html = generatePrintableHTML($reportType, $reportData, $report);
...
function generatePrintableHTML($reportType, $reportData, $report) {
    $html = '<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $html = generateReportHTML($reportType, $reportId);
