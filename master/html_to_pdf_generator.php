...
function generatePDF($reportType, $reportId) {
    try {
        ...
        if (function_exists('shell_exec')) {
            ...
            $command = "wkhtmltopdf --page-size A4 --margin-top 20mm --margin-bottom 20mm --margin-left 20mm --margin-right 20mm --encoding UTF-8 '$tempFile' '$pdfFile' 2>/dev/null";
...
<body>
    ...
    <script>
        // Auto-print when page loads (for browser PDF generation)
